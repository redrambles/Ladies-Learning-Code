...
function theme_setup() {
	...
	add_image_size('wide', 1200, 350, true);
...
/* =============================================================================
   				Custom Functions added by Wes Bos 
   ========================================================================== */

/* is_tree()  - figures out if a page is a child of a post ID */
...
/* Stock Custom Widget, uncomment to activate*/

class my_custom_widget_name extends WP_Widget {
	function success_stories() {
		parent::WP_Widget(false, 'Custom Widget Title');
	} 
	...
	function widget($args, $instance) {
			...
			echo "This is the widget body";
			echo $args['after_widget'];
		}
}
/* Uncomment to invoke 			register_widget('my_custom_widget_name'); */
...
// Uncomment to invoke 			add_filter('tiny_mce_before_init', 'make_mce_awesome');
...
/* get_post_thumbnail_url() - Returns the post thumbnail URL without any goofin' around */ 
